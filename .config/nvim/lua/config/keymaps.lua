...
vim.api.nvim_set_keymap("n", "<leader>p", '"_dP', { noremap = true, silent = true }) -- Normal mode paste without overwriting clipboard
vim.api.nvim_set_keymap("x", "<leader>p", '"_dP', { noremap = true, silent = true })

vim.api.nvim_set_keymap("n", "<leader>dpp", "<Nop>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>dph", "<Nop>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<leader>dps", "<Nop>", { noremap = true, silent = true })
...
-- disable for until I figure another keybind for lock
vim.keymap.set({ "n", "i" }, "<M-l>", "<nop>")
...
-- Function to split horizontally and resize the new window to 25% of current height
-- local function split_horizontally_25()
--   vim.cmd('split')
--   local total_height = vim.fn.winheight(0)
--   local new_height = math.floor(total_height * 0.25)
--   vim.cmd('resize ' .. new_height)
-- end

-- Map a key combination (e.g., <Leader>25s) to trigger the function
-- vim.api.nvim_set_keymap('n', '<Leader>25s', ':lua split_horizontally_25()<CR>', { noremap = true, silent = true })
