...
#   rofi -show powermenu -modi powermenu:~/.config/rofi/plugins/lock_menu.sh
#
...
all=(lockscreen suspend shutdown reboot logout)
...
# actions[lockscreen]="/home/ainulakif/.config/i3lock-color/lock.sh"
#actions[switchuser]="???"
